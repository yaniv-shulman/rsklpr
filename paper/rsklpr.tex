...
We now analyze the behavior of the estimator as the sample size $N \to \infty$. Throughout this subsection, $w(u,v)$ denotes the population-level non-negative weight function appearing in the weighted population objective.
