...
\]
which is the empirical objective function used by the finite-sample implementation. The next section analyzes the corresponding oracle population objective.
\end{corollary}
